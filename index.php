      ...
      <div class="container">
        <div class="row m-3 p-2 ms-5">
          <div class="col-md-3 m-5 ">
            <img
              src="Images/category/dhalls.jpg"
              class="rounded"
              alt="dhalls"
              width="100%"
              height="100%"
          ...
          <div class="col-md-3 m-5">
            <img
              src="Images/category/dailyproducts.webp"
              class="rounded"
              alt="Daily Products"
              width="100%"
              height="100%"
          ...
          <div class="col-md-3 m-5">
            <img
              src="Images/category/snacks.jpg"
              class="rounded"
              alt="snacks"
              width="100%"
              height="100%"
        ...
        <div class="row m-3 ms-5">
            <div class="col-md-3 m-5">
              <img
                src="Images/category/liquids.jpg"
                class="rounded"
                alt="liquids"
                width="100%"
                height="100%"
